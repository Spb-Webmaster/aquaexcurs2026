...
class FleetSchoolBoyPage extends Page
{
    ...
    public function setting()
    {
        ...
        if (Storage::disk('config')->exists('moonshine/fleet_school_boy.php')) {
            $result = include(storage_path('app/public/config/moonshine/fleet_school_boy.php'));
        } else {
            $result = null;
        }
    ...
    {
        return $this->title ?: 'Школьные экскурсии';
    }
    ...
    protected function components(): iterable
    {
        ...
        return [
            FormBuilder::make('/moonshine/fleet_school_boy', FormMethod::POST)
                ->fields([
                            ...
                            Grid::make([
                                ...
                                Column::make([
                                    ...
                                    Box::make([
                                        ...
                                        Text::make('Алиас', 'slug')->default((isset($slug)) ? $slug : 'ships')->locked(),
