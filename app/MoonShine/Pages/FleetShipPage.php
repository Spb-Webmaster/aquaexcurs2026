...
class FleetShipPage extends Page
{
    ...
    public function setting()
    {
        ...
        if (Storage::disk('config')->exists('moonshine/fleet_ship.php')) {
            $result = include(storage_path('app/public/config/moonshine/fleet_ship.php'));
        } else {
            $result = null;
        }
    ...
    protected function components(): iterable
    {
        ...
        return [
            FormBuilder::make('/moonshine/fleet_ship', FormMethod::POST)
                ->fields([
                    ...
                    Tabs::make([
                        ...
                        Tab::make(__('Настройки'), [
                            ...
                            Grid::make([
                                ...
                                Column::make([
                                    Divider::make('Теплоходы компании'),
